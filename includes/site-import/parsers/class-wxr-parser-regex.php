 ...
 */
class AGS_Layouts_WXR_Parser_Regex {
	var $authors = array();
	var $posts = array();
	...
	function parse( $file ) {
		...
		if ( ! $wxr_version )
			return new WP_Error( 'WXR_parse_error', __( 'This does not appear to be a WXR file, missing/invalid WXR version number', 'wp-layouts-td' ) );
